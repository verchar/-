...
if __name__ == '__main__':
    VOC2Yolo(
        class_num={'Amaranthus': 0, 'Chenopodium': 1, 'Solanum nigrum': 2, 'Alhagi sparsifolia': 3, 'Purslane': 4, 'Convolvulus': 5, 'Setaria': 6, 'Amaranthus polygonoides': 7, 'Corn': 8},  # 标签种类
        voc_img_path=r'C:\Users\25053\Desktop\corndataset\images',  # 数据集图片文件夹存储路径
        voc_xml_path=r'C:\Users\25053\Desktop\corndataset\labels\pascal voc',  # 标签xml文件夹存储路径
        yolo_txt_save_path=r'C:\Users\25053\Desktop\corndataset\labels\yolo'  # 将要生成的txt文件夹存储路径
    )
